...
public interface ToolsRepository extends JpaRepository<Tools, Integer>{
  ...
  // QUANDO SE USA SQL NATIVO PARA PAGINATION, PRECISA COLOCAR O PARAMETRO COUNTQUERY
  // COM A O SELECT DE CONTAGEM DE DADOS PARA EVITAR BUG AO PASSAR VALORES COMO PARAMETRO NA URL
  @Query(
    value = 
